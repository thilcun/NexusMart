    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddMongo()
                    ...
                    .AddMongoRepository<CatalogProduct>("CatalogItems")
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "NexusMart.Inventory.Service", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "NexusMart.Inventory.Service v1"));
            }
        ...
        {
            //Needed to create randomness on the waiting for timeout of clients
            ...
            .AddPolicyHandler(Policy.TimeoutAsync<HttpResponseMessage>(1)); //Policy For Timeouts
        }
